        ...
        <>
            ...
            <Container fluid className="main-portfolio" id={props.id}>
                <Container>
                    <Row className="pt-5">
                        <Col align="center">
                            <img src={Portfolio1} className="img-border img-portfolio" onClick={() => handleShow(Portfolio1)} alt="portfolio-image"/>
                        </Col>
                        <Col>
                    ...
                    <Row className="pt-5 pb-5">
                        <Col align="center">
                            <img src={Bingo1} className="img-border img-portfolio" onClick={() => handleShow(Bingo1)} alt="portfolio-image"/>
                        </Col>
                        <Col>
